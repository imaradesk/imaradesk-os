...
import { Home, FolderOpen, FileText, CheckCircle, Settings, Files, Globe, Clock, FileEdit, AlertCircle, User, Archive } from 'lucide-react'
...
export default function KBSidebar({ views = [], currentView = 'all', activePage = 'articles', pendingCount = 0 }) {
  ...
  const quickActions = [
    ...
    { href: '/knowledgebase/categories/', label: 'Manage Categories', icon: FolderOpen, id: 'categories' },
      ...
      <div className="p-4 border-t border-gray-200">
        ...
        <nav className="space-y-1">
          {views.map((view) => {
            ...
            const isActive = activePage === 'articles' && currentView === view.id
            return (
            <button
              key={view.id}
